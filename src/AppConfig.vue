<template>
    ...
    <Sidebar v-model:visible="active" :position="isRTL ? 'left' : 'right'" :showCloseIcon="false"
        ...
        <div class="layout-config-panel flex flex-column">
            <div class="px-3 pt-3">
                <h5 :title="ambiente"><i class="pi pi-cog"/> Configurações da página</h5>
                <span>Selecione a configuração de tela desejada para o seu perfil de acesso.</span>
            ...
            <div class="layout-config-options p-3">
                ...
                <div class="flex">
                    <div class="flex align-items-center">
                        ...
                        <label for="layoutMode1" :class="{'ml-2': !isRTL, 'mr-2': isRTL}">Claro</label>
                    </div>
                    <div class="flex align-items-center" :class="{'ml-4': !isRTL, 'mr-4': isRTL}">
                        ...
                        <label for="layoutMode2" :class="{'ml-2': !isRTL, 'mr-2': isRTL}">Escuro</label>
                    </div>
                </div>
                ...
                <div class="flex">
                    <div class="flex flex-column">
                        <div class="flex align-items-center">
                            ...
                            <label for="menuMode1" :class="{'ml-2': !isRTL, 'mr-2': isRTL}">Vertical</label>
                        </div>
                    ...
                    <div class="flex flex-column" :class="{'ml-4': !isRTL, 'mr-4': isRTL}">
                        <div class="flex align-items-center">
                            ...
                            <label for="menuMode3" :class="{'ml-2': !isRTL, 'mr-2': isRTL}">Sobreposto</label>
                        </div>
                        <div class="flex align-items-center mt-3">
                            <RadioButton name="menuMode" value="slim" v-model="d_menuMode" id="menuMode4" @change="changeMenuMode($event, 'slim')"></RadioButton>
                            <label for="menuMode4" :class="{'ml-2': !isRTL, 'mr-2': isRTL}">Reduzido</label>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    data() {
        return {
            ...
            scale: this.$store.state.auth.user != null ? this.$store.state.auth.user.fonte : 14,
