<template>
    <div class="flex grid">
        ...
        <div class="col-2">
            <label>
                <strong>Pendências Fiscais</strong>
            </label>

            <Dropdown 
                v-model="pendenciaFiscal"
                :options="pendenciasFiscaisOptions"
        ...
        <div class="col-7">
            <label><strong class="ml-2">Período Criação</strong></label>
    ...
    export default {
        ...
        methods:{
            ...
            filtrar() { 
                ...
                this.filtros.pendenciasFiscais = this.pendenciaFiscal;
