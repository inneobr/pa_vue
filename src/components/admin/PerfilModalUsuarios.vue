    ...
    >
        <template #header>
            <div class="flex align-items-center">
                ...
                <h3 style="margin:0px 5px;">Usuarios</h3>
            </div>
        </template>
        <div class="grid">        
            <div class="col-12">
                ...
                >
                    ...
                    <Column field="matricula" header="Matrícula" style="width:8rem;" />
                    <Column field="nome" header="Nome" />
                    <Column field="estabelecimento" header="Estab." style="width:8rem;" />
                    <Column field="regional" header="Regional" style="width:8rem;" />
                </DataTable>
            </div>
        </div>
        <template #footer>
    ...
    export default {
        ...
        methods: {
            carregarDados() {
                ...
                PerfilService.getUsuariosPorPerfil(
                    this.pagina,
                    this.qtdRegistro,
                    this.idPerfil
                )
